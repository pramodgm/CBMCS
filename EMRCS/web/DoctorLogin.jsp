<%-- 
    ...
    Created on : 23 Jan, 2016, 5:14:05 PM
    Author     : Pramod
--%>
...
<div id="wb_Form1" style="position:absolute;left:430px;top:202px;width:507px;height:383px;z-index:6;">
    <form name="Form1" method="POST" action="docLoginVal.jsp" id="Form1">
<div id="wb_Text1" style="position:absolute;left:14px;top:17px;width:448px;height:66px;text-align:center;z-index:0;">
<span style="color:#000000;font-family:'Comic Sans MS';font-size:24px;">To View the medical records of your patient login here....</span></div>
...
</div><div id="wb_Text3" style="position:absolute;left:85px;top:305px;width:328px;height:16px;z-index:6;text-align:left;">
<a href="DoctorRegistration.jsp"> Not a Member yet Click Here...</a></div></body>
</html>
