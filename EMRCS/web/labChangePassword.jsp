<%-- 
    Document   : labChangePassword
    Created on : 8 May, 2016, 8:42:03 AM
    Author     : Pramod
--%>
...
<% Class.forName("com.mysql.jdbc.Driver");
            ...
            if(rs.getString("password").equals(passo))
            {
                ...
                {
                    query="UPDATE `labprofile` SET `password` = '"+pass+"' WHERE `labprofile`.`labID` = '"+userid+"'"; 
                    pst = con.prepareStatement(query);
                    ...
                    {%>
                                                                <div id="wb_Text1" style="position:absolute;left:147px;top:299px;z-index:1;text-align:left;">
                        <span style="color:#000000;font-family:'Comic Sans MS';font-size:20px;">Check your new password <a href='labSettings.jsp'>click here</a> to go back to re-enter password</span></div>
                    <%}
                }
                else
                {%>
                    <div id="wb_Text1" style="position:absolute;left:147px;top:299px;z-index:1;text-align:left;">
                        <span style="color:#000000;font-family:'Comic Sans MS';font-size:20px;">Passwords Don not match <a href='labSettings.jsp'>click here</a> to go back to re-enter password</span></div>
                <%}
            }
else
{%>
    <div id="wb_Text1" style="position:absolute;left:147px;top:299px;z-index:1;text-align:left;">
                        <span style="color:#000000;font-family:'Comic Sans MS';font-size:20px;">Current Password wrong <a href='labSettings.jsp'>click here</a> to go back to re-enter password</span></div>
                        <%}
            %>
    </body>
</html>
