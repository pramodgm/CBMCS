<%-- 
    Document   : SearchResult_doc
    Created on : 28 Apr, 2016, 9:33:48 PM
    Author     : Pramod
--%>
...
<link href="Search_Result_doc.css" rel="stylesheet">
</head>
<body>
...
<td class="cell0"><span style="color:#000000;font-family:'Comic Sans MS';font-size:16px;line-height:23px;"><a href="CheckList_Doc.jsp"> Add Check List</a> </span></td>
...
<span style="color:#000000;font-family:'Comic Sans MS';font-size:20px;"><a href="doctorProfile.jsp">Profile</a></span></div>
</body>
</html>