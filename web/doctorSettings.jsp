<%-- 
    Document   : doctorSettings
    Created on : 1 May, 2016, 8:33:22 PM
    Author     : Pramod
--%>
...
<form name="ChangePassword" method="get" action="docChangePassword.jsp" enctype="text/plain" id="Form1">
...
<div id="wb_Text2" style="position:absolute;left:1103px;top:108px;width:263px;height:26px;z-index:9;text-align:left;">
    <span style="color:#000000;font-family:'Comic Sans MS';font-size:19px;"><a href="logout.jsp">Logout</a></span></div>
</body>
</html>