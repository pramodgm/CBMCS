<%-- 
    Document   : LaboratoryLogin
    Created on : 23 Jan, 2016, 5:15:05 PM
    Author     : Pramod
--%>
...
<form name="Form1" method="post" action="labLoginVal.jsp"  id="Form1">
<div id="wb_Text1" style="position:absolute;left:14px;top:17px;width:448px;height:66px;text-align:center;z-index:0;">
<span style="color:#000000;font-family:'Comic Sans MS';font-size:24px;">Laboratory Login Here to Upload the test results of the patiens</span></div>
...
<div id="wb_Text3" style="position:absolute;left:85px;top:305px;width:328px;height:16px;z-index:6;text-align:left;">
    <a href="labRegistration.jsp"> Not a Member yet Click Here...</a></div></body>
